**Development in this repository has stopped. Development of the updated library can now be found in https://github.com/pusher/pusher-http-python/tree/1.0.0**
